...
namespace BEPUphysicsDrawer.Lines
{
    ...
    /// </summary>
    public class DisplayBallSocketJoint : LineDisplayObject<BallSocketJoint>
    {
        ...
        public override void Update()
        {
            ...
            aToConnection.PositionB = LineObject.ConnectionA.CenterOfMass + LineObject.OffsetA;

            bToConnection.PositionA = LineObject.ConnectionB.CenterOfMass;
            bToConnection.PositionB = LineObject.ConnectionB.CenterOfMass + LineObject.OffsetB;
