...
namespace BEPUphysicsDrawer.Lines
{
    ...
    /// </summary>
    public class DisplaySwivelHingeAngularJoint : LineDisplayObject<SwivelHingeAngularJoint>
    {
        ...
        public override void Update()
        {
            ...
            axisA.PositionB = LineObject.ConnectionA.CenterOfMass + LineObject.WorldHingeAxis;

            axisB.PositionA = LineObject.ConnectionB.CenterOfMass;
            axisB.PositionB = LineObject.ConnectionB.CenterOfMass + LineObject.WorldTwistAxis;
        }
    }
}