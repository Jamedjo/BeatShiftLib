...
namespace BEPUphysicsDrawer.Models
{
    ...
    /// </summary>
    public class DisplayCapsuleTest : DisplayEntity<Capsule>
    {
        /// <summary>
        ...
        {
            var n = new Vector3();
            var offset = new Vector3(0, DisplayedObject.Length / 2, 0);
            ...
            //Top
            vertices.Add(new VertexPositionNormalTexture(new Vector3(0, radius + DisplayedObject.Length / 2, 0), Vector3.Up, Vector2.Zero));
            //Upper hemisphere
            ...
            //Bottom
            vertices.Add(new VertexPositionNormalTexture(new Vector3(0, -radius - DisplayedObject.Length / 2, 0), Vector3.Down, Vector2.Zero));
